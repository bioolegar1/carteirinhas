...
export const STUDENT_CARDS: readonly StudentCardData[] = [
  ...
  },
  {
    ...
    fullName: 'Ricardo Olimpio Barros Cavaleiro de Macedo Filho',
    documentLabel: 'CPF/CIN',
    documentNumber: '003.239.102-11',
    ...
    validUntil: '06/12/2026',
    cieCode: '486C61C4',
    photoUrl: '/assets/photos/ricardo.jpeg',
    qrImageUrl: '/assets/qrs/ricardo-qrcode.png',
    issuer: sharedIssuer,
    validator: sharedValidator,
    benefit: sharedBenefit,
    supportPhone: '(31) 9 9327-1886',
  ...
  {
    id: 'jenifer',
    greetingName: 'Jenifer',
    fullName: 'Jenifer Gomes de Sousa',
    documentLabel: 'CPF/CIN',
    documentNumber: '171.050.757-83',
    ...
    validUntil: '06/12/2026',
    cieCode: '487B61C4',
    photoUrl: '/assets/photos/jenifer.jpeg',
    qrImageUrl: '/assets/qrs/jenifer-qrcode.png',
    issuer: sharedIssuer,
    validator: sharedValidator,
    benefit: sharedBenefit,
    supportPhone: '(31) 9 9327-1886',
